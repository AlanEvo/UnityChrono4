...
namespace chrono
{
    ...
    /// timestepper for DVIs.
    public class ChTimestepperEulerImplicitProjected : ChTimestepperIIorder, IChImplicitTimestepper
    {


        protected ChStateDelta Vold;
        protected ChVectorDynamic<double> Dl;
        protected ChVectorDynamic<double> R;
        protected ChVectorDynamic<double> Qc;
        ...
        public override Type GetType()  { return Type.EULER_IMPLICIT_PROJECTED; }
