...
namespace chrono
{
    ...
    public class ChSolverSymmSOR : ChIterativeSolver
    {

        public ChSolverSymmSOR(int mmax_iters = 50,       //< max.number of iterations
        ...
        public override Type GetType() { return Type.SYMMSOR; }
