...
namespace chrono
{
    ...
    {
        [DllImport("ChronoEngine", EntryPoint = "ChShaftsClutch_Create")]
        public static extern IntPtr ChShaftsClutch_Create(out IntPtr shaft);
        [DllImport("ChronoEngine", EntryPoint = "ChShaftsClutch_Initialize")]
        public static extern bool ChShaftsClutch_Initialize(IntPtr shaft, IntPtr mshaft1, IntPtr mshaft2);
        [DllImport("ChronoEngine", EntryPoint = "ChShaftsClutch_SetTorqueLimit")]
        public static extern void ChShaftsClutch_SetTorqueLimit(IntPtr shaft, double ml);
        [DllImport("ChronoEngine", EntryPoint = "ChShaftsClutch_SetModulation")]
        public static extern void ChShaftsClutch_SetModulation(IntPtr shaft, double mm);
        [DllImport("ChronoEngine", EntryPoint = "ChShaftsClutch_GetTorqueReactionOn1")]
        public static extern double ChShaftsClutch_GetTorqueReactionOn1(IntPtr shaft);
        [DllImport("ChronoEngine", EntryPoint = "ChShaftsClutch_GetTorqueReactionOn2")]
        public static extern double ChShaftsClutch_GetTorqueReactionOn2(IntPtr shaft);
