    ...
    public class ChLinkGear : ChLinkLock
    {
       ...
       // public bool epicyclic = false;
        ...
        public override void UpdateTime(double mytime) {
            ...
            ChFrame<double> abs_shaft2 = new ChFrame<double>();
            ...
            // is a bevel gear?
            double be = Math.Cos(ChVector.Vdot(Get_shaft_dir1(), Get_shaft_dir2()));
            bool is_bevel = true;
            ...
            else
            {
                ...
                double al = ChMaths.CH_C_PI - Math.Cos(ChVector.Vdot(Get_shaft_dir2(), my));
            ...
            deltaC.rot = new ChQuaternion(1, 0, 0, 0);  // no relative rotations imposed!
            deltaC_dt.rot = new ChQuaternion(0, 0, 0, 0);
            deltaC_dtdt.rot = new ChQuaternion(0, 0, 0, 0);
        }
        ...
        public ChVector Get_shaft_dir1() {
            if (Body1 != null) 
            {
                ChFrame<double> absframe = new ChFrame<double>();
