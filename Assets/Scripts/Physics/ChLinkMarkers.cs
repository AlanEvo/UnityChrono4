...
namespace chrono
{
    ...
    public class ChLinkMarkers : ChLink
    {
        ...
        protected ChCoordsys relM = new ChCoordsys();       //< relative marker position 2-1
        protected ChCoordsys relM_dt = new ChCoordsys();    //< relative marker speed
        protected ChCoordsys relM_dtdt = new ChCoordsys();  //< relative marker acceleration
        ...
        public override ChCoordsys GetLinkRelativeCoords() { return marker2.FrameMoving.GetCoord(); }
        ...
        public ChCoordsys GetRelM() { return relM; }

        /// Relative speed of marker 1 respect to marker 2.
        public ChCoordsys GetRelM_dt() { return relM_dt; }
        /// Relative acceleration of marker 1 respect to marker 2.
        public ChCoordsys GetRelM_dtdt() { return relM_dtdt; }
