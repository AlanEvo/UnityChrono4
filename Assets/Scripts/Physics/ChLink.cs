...
namespace chrono
{
    ...
    public class ChLink : ChLinkBase
    {
        ...
        public virtual ChCoordsys GetLinkRelativeCoords() { return new ChCoordsys(new ChVector(0, 0, 0), new ChQuaternion(0, 0, 0, 0)); }
        ...
        public override ChCoordsys GetLinkAbsoluteCoords() { return ChCoordsys.BitShiftRight(GetLinkRelativeCoords() , Body2.GetCoord()); }
