...
namespace chrono
{
    ...
    public class ChBody : ChPhysicsItem, ChContactable_1vars<IntInterface.Six>, IChLoadableUVW
    {
        ...
        public ChBodyFrame BodyFrame;// = new ChBodyFrame();
        ...
        protected ChCoordsys<double> last_coll_pos;  //< cached position at last collision
      ...
      //  public Vector3 COM;
        ...
        public override void VariablesQbSetSpeed(double step = 0) {
            ChCoordsys<double> old_coord_dt = this.BodyFrame.GetCoord_dt();
        ...
        public ChCoordsys<double> GetLastCollPos() { return last_coll_pos; }
    ...
    public ChVector GetContactPointSpeed(ChVector loc_point,
        ...
        public ChCoordsys<double> GetCsysForCollisionModel() { return new ChCoordsys<double>(this.GetFrame_REF_to_abs().coord); }
    ...
    public class ChBodyEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            body.type = (ChBody.CollisionType)EditorGUILayout.EnumPopup("Collision Type", body.type);
