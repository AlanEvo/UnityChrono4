...
namespace chrono
{
    ...
    public class ChLinkEngine : ChLinkLock
    {
        ...
        private eCh_eng_mode eng_mode;// = eCh_eng_mode.ENG_MODE_KEY_ROTATION;  //< mode of controlling the motor (by rotation, speed etc.)
        public eCh_eng_mode EngineMode = eCh_eng_mode.ENG_MODE_ROTATION;
