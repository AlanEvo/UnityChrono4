...
namespace chrono
{
    ...
    public class ChLinkLock : ChLinkMasked
    {
        ...
        protected ChCoordsys<double> relC;       //< relative constraint position: relC = (relM-deltaC)

        protected ChCoordsys<double> relC_dt;    //< relative constraint speed
        protected ChCoordsys<double> relC_dtdt;  //< relative constraint acceleration

        protected ChCoordsys<double> deltaC;       //< user-imposed rel. position
        protected ChCoordsys<double> deltaC_dt;    //< user-imposed rel. speed
        protected ChCoordsys<double> deltaC_dtdt;  //< user-imposed rel. acceleration
       ...
       // [SerializeField]
        ...
        public override void UpdateRelMarkerCoords() {
            ...
            // PROBLEM Something is wrong in this block commented out!  It has something to do with the revolute joint, refer
            // to UJoint demo and uncomment this code out to see the effect.
            // SOLVED Sometimes the markers need to marker.GetBody.BodyFrame rotation!
        ...
        public override void UpdateState() {
            ...
            if (mmask.Constr_E0().IsActive())  // for E0 constraint...
            {
                ...
                //Debug.Log("data e0 " + relC_dtdt.rot.e0);
            ...
            if (mmask.Constr_E1().IsActive())  // for E1 constraint...
            {
               ...
               // Debug.Log("data e1 " + relC_dtdt.rot.e0);
            ...
            if (mmask.Constr_E2().IsActive())  // for E2 constraint...
            {
               ...
               // Debug.Log("data e3 " + relC_dtdt.rot.e0);
        ...
        public ChCoordsys<double> GetRelC() { return relC; }
        public ChCoordsys<double> GetRelC_dt() { return relC_dt; }
        public ChCoordsys<double> GetRelC_dtdt() { return relC_dtdt; }

        // to get the imposed clearances
        public ChCoordsys<double> GetDeltaC() { return deltaC; }
        public ChCoordsys<double> GetDeltaC_dt() { return deltaC_dt; }
        public ChCoordsys<double> GetDeltaC_dtdt() { return deltaC_dtdt; }
        // to set the imposed clearances (best use SetMotion() if you can..)
        public void SetDeltaC(Coordsys mc) { deltaC = mc; }
        public void SetDeltaC_dt(Coordsys mc) { deltaC_dt = mc; }
        public void SetDeltaC_dtdt(Coordsys mc) { deltaC_dtdt = mc; }
  ...
  /*  [CustomEditor(typeof(ChLinkLock))]
    public class UChJointRevoluteEditor : Editor
    {
        override public void OnInspectorGUI()
        {
            ...
            joint.type = (ChLinkLock.LinkType)EditorGUILayout.EnumPopup("Joint Type", joint.type);
            joint.body1 = (ChBody)EditorGUILayout.ObjectField("Body 1", joint.body1, typeof(ChBody), true);
            joint.body2 = (ChBody)EditorGUILayout.ObjectField("Body 2", joint.body2, typeof(ChBody), true);
