    ...
    public class ChBodyAuxRefEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                GUIContent com = new GUIContent("Centre Of Mass", "Set the COG frame with respect to the auxiliary reference frame. Note that this also moves the body absolute COG (the REF is fixed). The position of contained ChMarker objects, if any, is not changed with respect to the reference.");
