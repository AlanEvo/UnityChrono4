...
namespace chrono
{
    ...
    {
        public ChCoordsys<Real> coord_dt = new ChCoordsys<Real>();    //< Rotation and position speed, as vector+quaternion
        public ChCoordsys<Real> coord_dtdt = new ChCoordsys<Real>();  //< Rotation and position acceleration, as vector+quaternion
        ...
        public ChFrameMoving(ChCoordsys<Real> mc) : base(mc)
        {
            coord_dt.rot = coord_dtdt.rot = new ChQuaternion(0, 0, 0, 0);
        }
        ...
        public ChCoordsys<Real> GetCoord_dt() { return coord_dt; }

        /// Return both current rotation and translation accelerations as
        /// a coordsystem object, with vector and quaternion
        public ChCoordsys<Real> GetCoord_dtdt() { return coord_dtdt; }
        ...
        public virtual void SetCoord_dt(ChCoordsys<Real> mcoord_dt) { coord_dt = mcoord_dt; }
        ...
        /// single ChCoordsys derivative.
        public virtual void SetCoord_dtdt(ChCoordsys<Real> mcoord_dtdt) { coord_dtdt = mcoord_dtdt; }
        ...
        public void Compute_Adt(ref ChMatrix33<Real> mA_dt)
        {
            ...
            ChMatrixNM<IntInterface.Three, IntInterface.Four> Fpdt = new ChMatrixNM<IntInterface.Three, IntInterface.Four>();
        ...
        public void Compute_Adtdt(ref ChMatrix33<Real> mA_dtdt)
        {
            ...
            ChMatrix33<Real> mr = new ChMatrix33<Real>();
