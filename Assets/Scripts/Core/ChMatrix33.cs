...
namespace chrono
{
    ...
    public unsafe class ChMatrix33<Real> : ChMatrixNM<IntInterface.Three, IntInterface.Three>
    {
        public static ChMatrix33<double> MNULL = new ChMatrix33<double>();
        ...
        {
            ChMatrix33<double> result = new ChMatrix33<double>();
