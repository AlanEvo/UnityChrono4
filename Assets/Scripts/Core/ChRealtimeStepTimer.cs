...
namespace chrono
{
    ...
    public class ChRealtimeStepTimer : ChTimer<double>
    {
       ...
       // public void Start() { this.start(); }
        ...
        public double SuggestSimulationStep(double max_step = 0.02,                                    //< upper limit for step
                                 double min_step = double.Epsilon)  //< lower limit for step
        {
            this.stop();
