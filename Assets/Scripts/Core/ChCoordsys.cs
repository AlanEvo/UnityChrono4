...
namespace chrono
{
    ...
    public class ChCoordsys
    {
        ...
        public static bool operator ==(ChCoordsys a, ChCoordsys other)
        {
            return a.rot == other.rot && a.pos == other.pos;
        }
       ...
       /* public bool Equals(ChCoordsys other, double tol)
        ...
        /* public static Coordsys Force2Dcsys(Coordsys cs)
            ...
            // public static ChCoordsys CSYSNULL = new ChCoordsys(new ChVector(0, 0, 0), ChQuaternion.QNULL);
            // public static ChCoordsys CSYSNORM = new ChCoordsys(new ChVector(0, 0, 0), ChQuaternion.QUNIT);

         }*/

        public static ChCoordsys CSYSNULL = new ChCoordsys(ChVector.VNULL, ChQuaternion.QNULL);
        public static ChCoordsys CSYSNORM = new ChCoordsys(ChVector.VNULL, ChQuaternion.QUNIT);

        /// Shortcut for faster use of typical double-precision coordsys.
        ///  Instead of writing    "ChCoordsys foo;"   you can write
        ///  the shorter version   "Coordsys foo;"
        ///
        // public class Coordsys : ChCoordsys { }
