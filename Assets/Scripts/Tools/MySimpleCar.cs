...
namespace chrono {
    ...
    public class MySimpleCar : MonoBehaviour
    {
        ...
        public ChLinkMotorRotationSpeed link_engineL;
        public ChLinkMotorRotationSpeed link_engineR;
        ...
        void FixedUpdate()
        {
            ...
            double newsteer = 0.18 * (((double)(horizontal - 50)) / 50.0);
        ...
        double ComputeWheelTorque()
        {
           ...
           /* ChFunction_Const mfun = new ChFunction_Const();
            if (mfun = (ChFunction_Const)(link_engineL.Get_tor_funct()))
