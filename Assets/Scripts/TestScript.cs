...
{
    public static MyVector VNULL = new MyVector(0.0, 0.0, 0.0);
...
public class MyBase<Real>
{
    public static MyBase<Real> BNULL = new MyBase<Real>();
...
public class MyVector<Real> : MyBase<Real>
{
    public static MyVector<Real> VNULL = new MyVector<Real>();
    ...
    public MyVector(Real x, Real y, Real z)
    {
        this.x = x;
        this.y = y;
        this.z = z;
...
public class TestScript : MonoBehaviour
{
    ...
    void Start()
    {
        MyBase<double> vec = MyBase<double>.BNULL;
        MyVector<double> vec2 = MyVector<double>.VNULL;

        // ChBody body = gameObject.AddComponent<ChBody>();
        ...
        /* ChVector vtraslA = new ChVector(5, 6, 7);         // origin of local frame w.r.t. global frame
         ...
         ChCoordsys csysA = new ChCoordsys(vtraslA, qrotA);  // corresponding coordinate system (translation + rotation)
